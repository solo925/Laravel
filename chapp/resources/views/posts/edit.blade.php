<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('posts.show', $post) }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    ...
                    <div class="space-y-6">
                        ...
                        @if($post->image_url)
                            <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-700">
                                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Current Image:</h4>
                                <img src="{{ $post->image_url }}" alt="Current image" class="max-w-full h-48 object-cover rounded-lg">
                            </div>
                        @endif

                        <!-- Preview Section for new image -->
                        <div id="new-image-preview" class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-700" style="display: none;">
                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">New Image Preview:</h4>
